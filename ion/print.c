...
void
print_stmt_block(StmtList block)
{
    printf("(block");
    indent++;
...
void
print_aggregate_decl(Decl* decl)
{
    Decl* d = decl;
...
print_test(void)
{
    ...
    Stmt* stmts[] = {
        ...
        stmt_expr(expr_call(expr_name("print"), (Expr*[])
        {
            expr_int(1), expr_int(2)
        }, 2)),
