...
StmtList
stmt_list(Stmt** stmts, size_t num_stmts)
{
    return (StmtList) {
...
Typespec*
typespec_new(TypespecKind kind)
{
...
Decl*
decl_new(DeclKind kind, const char* name)
{
...
Decl*
decl_enum(const char* name, EnumItem* items, size_t num_items)
{
...
Decl*
decl_aggregate(DeclKind kind, const char* name, AggregateItem* items, size_t num_items)
{
...
Decl*
decl_union(const char* name, AggregateItem* items, size_t num_items)
{
...
Decl*
decl_var(const char* name, Typespec* type, Expr* expr)
{
...
Decl*
decl_func(const char* name, FuncParam* params, size_t num_params, Typespec* ret_type, StmtList block)
{
...
Decl*
decl_const(const char* name, Expr* expr)
{
...
Decl*
decl_typedef(const char* name, Typespec* type)
{
...
Expr*
expr_sizeof_type(Typespec* type)
{
...
Expr*
expr_compound(Typespec* type, CompoundField* fields, size_t num_fields)
{
...
Stmt*
stmt_if(Expr* cond, StmtList then_block, ElseIf* elseifs, size_t num_elseifs, StmtList else_block)
{
...
Stmt*
stmt_while(Expr* cond, StmtList block)
{
...
Stmt*
stmt_do_while(Expr* cond, StmtList block)
{
...
Stmt*
stmt_for(Stmt* init, Expr* cond, Stmt* next, StmtList block)
{
...
Stmt*
stmt_switch(Expr* expr, SwitchCase* cases, size_t num_cases)
{
...
Stmt*
stmt_assign(TokenKind op, Expr* left, Expr* right)
{
...
Stmt*
stmt_init(const char* name, Expr* expr)
{
